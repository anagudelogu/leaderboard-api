...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _modules_utility__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/utility */ \"./src/modules/utility.js\");\n/* harmony import */ var _modules_userInterface__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/userInterface */ \"./src/modules/userInterface.js\");\n\n\n\n\nconst form = document.querySelector('form');\nconst refreshBtn = document.querySelector(\n\t'.leaderboard__header--btn'\n);\nconst addScoreBtn = document.querySelector('.new__form--btn');\n// const LoadLeaderboard = async () => {\n// \tconst obj = {\n// \t\tname: 'Name 1',\n// \t\tscore: '1000',\n// \t};\n// \tconst add = await Utility.createNewScoreAPI(obj);\n// \tUserInterface.createDOM(obj);\n// };\n\n// LoadLeaderboard();\n\nwindow.addEventListener('load', async () => {\n\tconst display = await _modules_userInterface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].displayScores();\n});\n\nrefreshBtn.addEventListener('click', async () => {\n\tconst display = await _modules_userInterface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].displayScores();\n});\n\naddScoreBtn.addEventListener('click', async () => {\n\tconst [name, score] = Array.from(form.elements);\n\tconst newScr = { name: name, score: score };\n\tconst add = await _modules_utility__WEBPACK_IMPORTED_MODULE_1__[\"default\"].createNewScoreAPI(newScr);\n\t_modules_userInterface__WEBPACK_IMPORTED_MODULE_2__[\"default\"].createDOM(newScr);\n});\n\n\n//# sourceURL=webpack://webpack-boilerplate/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Game)\n/* harmony export */ });\n/* harmony import */ var _fetchRequest__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetchRequest */ \"./src/modules/fetchRequest.js\");\n\n\nclass Game {\n\tname;\n\turl =\n\t\t'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/';\n\tmethod = 'POST';\n\tconstructor({ name }) {\n\t\tthis.name = name;\n\t}\n\n\tasync newGame() {\n\t\ttry {\n\t\t\tconst fetchRequest = new _fetchRequest__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n\t\t\t\tmethod: this.method,\n\t\t\t\tbody: { name: this.name },\n\t\t\t\turl: this.url,\n\t\t\t});\n\t\t\treturn await fetchRequest.call();\n\t\t} catch (error) {\n\t\t\tconsole.error(error);\n\t\t}\n\t}\n\n\tasync getGameId() {\n\t\tconst gameName = await this.newGame();\n\t\tconst gameId = gameName.result\n\t\t\t.replace('Game with ID: ', '')\n\t\t\t.replace(' added.', '');\n\t\treturn gameId;\n\t}\n}\n\n\n//# sourceURL=webpack://webpack-boilerplate/./src/modules/game.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Utility)\n/* harmony export */ });\n/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game */ \"./src/modules/game.js\");\n/* harmony import */ var _score__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./score */ \"./src/modules/score.js\");\n/* harmony import */ var _leaderboard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./leaderboard */ \"./src/modules/leaderboard.js\");\n\n\n\n\nclass Utility {\n\tstatic async startGameAndGetUrl() {\n\t\tconst game = new _game__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({ name: 'My game' });\n\t\tconst gameId = await game.getGameId();\n\t\tconst gameUrl = `https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${gameId}/scores`;\n\t\treturn gameUrl;\n\t}\n\n\tstatic async createNewScoreAPI({ name, score }) {\n\t\tconst scr = new _score__WEBPACK_IMPORTED_MODULE_1__[\"default\"]({ name: name, score: score });\n\t\tconsole.log(scr);\n\t\tconst gameUrl = await Utility.startGameAndGetUrl();\n\t\tconst addScore = await _leaderboard__WEBPACK_IMPORTED_MODULE_2__[\"default\"].addScore(scr, gameUrl);\n\t\tconsole.log(addScore);\n\t\treturn addScore;\n\t}\n}\n\n\n//# sourceURL=webpack://webpack-boilerplate/./src/modules/utility.js?");
